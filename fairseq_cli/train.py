...
def validate_and_save(
    ...
    valid_losses = [None]
    if do_validate:
        valid_losses, analysis_tuple = validate(cfg, trainer, task, epoch_itr, valid_subsets)
...
def cli_main(
    ...
    with open_dict(cfg):
        ...
        cfg.checkpoint.save_dir = cfg.checkpoint.save_dir  + '/'+cfg.task.data.split('.')[-1] + '-'+ args.choose
